...
\newcommand{\hmwkDueDate}{March 7, 2019}
...
Homework 5 helps us get more familiar with the arduino's language by having us
...
Modify the Blink program you did from Chapter 3 (Arduino UNO version on page 85
of the textbook) so that the function MyDelay(mSecondsApx) uses the Arduino
ATmega2560 timer1 in Normal mode to generate a delay of (mSecondsApx *
one millisecond) before returning.
\end{lstlisting}
